 ...
 * heading measured clockwise from north. <i>azi2</i> is the "forward" azimuth,
 * i.e., the heading that takes you beyond point 2 not back to point 1.)
 * <p>
 * Given <i>lat1</i>, <i>lon1</i>, <i>azi1</i>, and <i>s12</i>, we can determine
 * <i>lat2</i>, <i>lon2</i>, and <i>azi2</i>. This is the <i>direct</i> geodesic
 * problem and its solution is given by the function {@link #Direct Direct}. (If
 * <i>s12</i> is sufficiently large that the geodesic wraps more than halfway
 * around the earth, there will be another geodesic between the points with a
 * smaller <i>s12</i>.)
 * <p>
 ...
 * where there are multiple solutions (all with the same <i>s12</i>, of course),
 * all the solutions can be easily generated once a particular solution is
 * provided.
 * <p>
 * The standard way of specifying the direct problem is the specify the distance
 * <i>s12</i> to the second point. However it is sometimes useful instead to
 * specify the arc length <i>a12</i> (in degrees) on the auxiliary sphere. This
 * is a mathematical construct used in solving the geodesic problems. The
 * solution of the direct problem in this form is provided by {@link #ArcDirect
 * ArcDirect}. An arc length in excess of 180&deg; indicates that the geodesic
 * is not a shortest path. In addition, the arc length between an equatorial
 * crossing and the next extremum of latitude for a geodesic is 90&deg;.
 * <p>
 * This class can also calculate several other quantities related to geodesics.
 * These are:
 * <ul>
 * <li><i>reduced length</i>. If we fix the first point and increase <i>azi1</i>
 * by <i>dazi1</i> (radians), the second point is displaced <i>m12</i>
 * <i>dazi1</i> in the direction <i>azi2</i> + 90&deg;. The quantity <i>m12</i>
 * is called the "reduced length" and is symmetric under interchange of the two
 * points. On a curved surface the reduced length obeys a symmetry relation,
 * <i>m12</i> + <i>m21</i> = 0. On a flat surface, we have <i>m12</i> =
 * <i>s12</i>. The ratio <i>s12</i>/<i>m12</i> gives the azimuthal scale for an
 * azimuthal equidistant projection.
 * <li><i>geodesic scale</i>. Consider a reference geodesic and a second
 ...
 * surface, we have <i>M12</i> = <i>M21</i> = 1. The quantity 1/<i>M12</i> gives
 * the scale of the Cassini-Soldner projection.
 * <li><i>area</i>. The area between the geodesic from point 1 to point 2 and
 ...
 * (<i>lat2</i>,<i>lon2</i>). It can be used to compute the area of any geodesic
 * polygon.
 * </ul>
 * <p>
 ...
 * <ul>
 * <li><i>s13</i> = <i>s12</i> + <i>s23</i>
 * <li><i>a13</i> = <i>a12</i> + <i>a23</i>
 * <li><i>S13</i> = <i>S12</i> + <i>S23</i>
 * <li><i>m13</i> = <i>m12</i> <i>M23</i> + <i>m23</i> <i>M21</i>
 * <li><i>M13</i> = <i>M12</i> <i>M23</i> &minus; (1 &minus; <i>M12</i>
 * <i>M21</i>) <i>m23</i> / <i>m12</i>
 * <li><i>M31</i> = <i>M32</i> <i>M21</i> &minus; (1 &minus; <i>M23</i>
 * <i>M32</i>) <i>m12</i> / <i>m23</i>
 * </ul>
 * <p>
 * The results of the geodesic calculations are bundled up into a
 * {@link GeodesicData} object which includes the input parameters and all the
 ...
 * optional final argument <i>outmask</i> which allows you specify which results
 * should be computed and returned. If you omit <i>outmask</i>, then the
 * "standard" geodesic results are computed (latitudes, longitudes, azimuths,
 * and distance). <i>outmask</i> is bitor'ed combination of {@link GeodesicMask}
 ...
 * }</pre>
 * <p>
 * Additional functionality is provided by the {@link GeodesicLine} class, which
 ...
 * multiple azimuths which yield the same shortest distance. Here is a catalog
 * of those cases:
 * <ul>
 * <li><i>lat1</i> = &minus;<i>lat2</i> (with neither point at a pole). If
 * <i>azi1</i> = <i>azi2</i>, the geodesic is unique. Otherwise there are two
 * geodesics and the second one is obtained by setting [<i>azi1</i>,
 * <i>azi2</i>] &rarr; [<i>azi2</i>, <i>azi1</i>], [<i>M12</i>, <i>M21</i>]
 * &rarr; [<i>M21</i>, <i>M12</i>], <i>S12</i> &rarr; &minus;<i>S12</i>. (This
 * occurs when the longitude difference is near &plusmn;180&deg; for oblate
 * ellipsoids.)
 * <li><i>lon2</i> = <i>lon1</i> &plusmn; 180&deg; (with neither point at a
 * pole). If <i>azi1</i> = 0&deg; or &plusmn;180&deg;, the geodesic is unique.
 * Otherwise there are two geodesics and the second one is obtained by setting [
 * <i>azi1</i>, <i>azi2</i>] &rarr; [&minus;<i>azi1</i>, &minus;<i>azi2</i>],
 * <i>S12</i> &rarr; &minus; <i>S12</i>. (This occurs when <i>lat2</i> is near
 * &minus;<i>lat1</i> for prolate ellipsoids.)
 * <li>Points 1 and 2 at opposite poles. There are infinitely many geodesics
 ...
 * antipodal.)
 * <li><i>s12</i> = 0 (coincident points). There are infinitely many geodesics
 * which can be generated by setting [<i>azi1</i>, <i>azi2</i>] &rarr;
 ...
 * obtained for |<i>f</i>| &lt; 0.2. Here is a table of the approximate maximum
 ...
 * <ul>
 * <li>C. F. F. Karney, <a href="https://doi.org/10.1007/s00190-012-0578-z">
...
public class Geodesic {
    ...
    protected static final double tiny_ = StrictMath.sqrt(Double.MIN_NORMAL);
    private static final double tol0_ = StrictMath.ulp(1.0);
    ...
    private static final double tol2_ = StrictMath.sqrt(tol0_);
     ...
     * @param f
     *            flattening of ellipsoid. Setting <i>f</i> = 0 gives a sphere.
     *            Negative <i>f</i> gives a prolate ellipsoid.
     * @exception GeographicErr
     *                if <i>a</i> or (1 &minus; <i>f</i> ) <i>a</i> is not positive.
     **********************************************************************/
    public Geodesic(double a, double f) {
        ...
        _n = _f / (2 - _f);
        _b = _a * _f1;
        _c2 = (GeoMath.sq(_a) + GeoMath.sq(_b) * (_e2 == 0 ? 1
                : (_e2 > 0 ? GeoMath.atanh(StrictMath.sqrt(_e2)) : StrictMath.atan(StrictMath.sqrt(-_e2)))
                        / StrictMath.sqrt(StrictMath.abs(_e2))))
        ...
        // spherical case.
        _etol2 = 0.1 * tol2_
                / StrictMath.sqrt(StrictMath.max(0.001, StrictMath.abs(_f)) * StrictMath.min(1.0, 1 - _f / 2) / 2);
     ...
     * @param s12
     *            distance between point 1 and point 2 (meters); it can be negative.
     * @return a {@link GeodesicData} object with the following fields: <i>lat1</i>,
     *         <i>lon1</i>, <i>azi1</i>, <i>lat2</i>, <i>lon2</i>, <i>azi2</i>,
     *         <i>s12</i>, <i>a12</i>.
     *         <p>
     *         <i>lat1</i> should be in the range [&minus;90&deg;, 90&deg;]. The
     *         values of <i>lon2</i> and <i>azi2</i> returned are in the range
     *         [&minus;180&deg;, 180&deg;].
     *         <p>
     *         If either point is at a pole, the azimuth is defined by keeping the
     *         longitude fixed, writing <i>lat</i> = &plusmn;(90&deg; &minus;
     ...
     *            distance between point 1 and point 2 (meters); it can be negative.
     * @param outmask
     *            a bitor'ed combination of {@link GeodesicMask} values specifying
     ...
     *         always included in the returned result. The value of <i>lon2</i>
     *         returned is in the range [&minus;180&deg;, 180&deg;], unless the
     *         <i>outmask</i> includes the {@link GeodesicMask#LONG_UNROLL} flag.
     **********************************************************************/
     ...
     *         <i>outmask</i> computed.
     *         <p>
     *         <i>lat1</i>, <i>lon1</i>, <i>azi1</i>, and <i>a12</i> are always
     *         included in the returned result. The value of <i>lon2</i> returned is
     *         in the range [&minus;180&deg;, 180&deg;], unless the <i>outmask</i>
     ...
     *            azimuth at point 1 (degrees).
     * @param arcmode
     *            boolean flag determining the meaning of the <i>s12_a12</i>.
     * @param s12_a12
     *            if <i>arcmode</i> is false, this is the distance between point 1
     *            and point 2 (meters); otherwise it is the arc length between point
     *            1 and point 2 (degrees); it can be negative.
     * @param outmask
     *            a bitor'ed combination of {@link GeodesicMask} values specifying
     *            which results should be returned.
     * @return a {@link GeodesicData} object with the fields specified by
     ...
     *         <ul>
     *         <li><i>outmask</i> |= {@link GeodesicMask#LATITUDE} for the latitude
     *         <i>lat2</i>;
     *         <li><i>outmask</i> |= {@link GeodesicMask#LONGITUDE} for the latitude
     *         <i>lon2</i>;
     *         <li><i>outmask</i> |= {@link GeodesicMask#AZIMUTH} for the latitude
     *         <i>azi2</i>;
     *         <li><i>outmask</i> |= {@link GeodesicMask#DISTANCE} for the distance
     *         <i>s12</i>;
     *         <li><i>outmask</i> |= {@link GeodesicMask#REDUCEDLENGTH} for the
     *         reduced length <i>m12</i>;
     *         <li><i>outmask</i> |= {@link GeodesicMask#GEODESICSCALE} for the
     *         geodesic scales <i>M12</i> and <i>M21</i>;
     *         <li><i>outmask</i> |= {@link GeodesicMask#AREA} for the area
     *         <i>S12</i>;
     *         <li><i>outmask</i> |= {@link GeodesicMask#ALL} for all of the above;
     *         <li><i>outmask</i> |= {@link GeodesicMask#LONG_UNROLL}, if set then
     *         <i>lon1</i> is unchanged and <i>lon2</i> &minus; <i>lon1</i>
     *         indicates how many times and in what sense the geodesic encircles the
     *         ellipsoid. Otherwise <i>lon1</i> and <i>lon2</i> are both reduced to
     *         the range [&minus;180&deg;, 180&deg;].
     *         </ul>
     *         <p>
     *         The function value <i>a12</i> is always computed and returned and
     *         this equals <i>s12_a12</i> is <i>arcmode</i> is true. If
     *         <i>outmask</i> includes {@link GeodesicMask#DISTANCE} and
     *         <i>arcmode</i> is false, then <i>s12</i> = <i>s12_a12</i>. It is not
     *         necessary to include {@link GeodesicMask#DISTANCE_IN} in
     *         <i>outmask</i>; this is automatically included is <i>arcmode</i> is
     *         false.
     **********************************************************************/
    public GeodesicData Direct(double lat1, double lon1, double azi1, boolean arcmode, double s12_a12, int outmask) {
        ...
        return new GeodesicLine(this, lat1, lon1, azi1, outmask). // Note the dot!
     ...
     *         <p>
     *         This function sets point 3 of the GeodesicLine to correspond to point
     *         2 of the direct geodesic problem.
     *         <p>
     ...
     *            distance between point 1 and point 2 (meters); it can be negative.
     * @param caps
     *            bitor'ed combination of {@link GeodesicMask} values specifying the
    ...
    /**
     * Define a {@link GeodesicLine} in terms of the direct geodesic problem
     * specified in terms of arc length with a subset of the capabilities included.
     * <p>
     * 
     * @param lat1
     *            latitude of point 1 (degrees).
     ...
     *         <i>lat1</i> should be in the range [&minus;90&deg;, 90&deg;].
     **********************************************************************/
    public GeodesicLine GenDirectLine(double lat1, double lon1, double azi1, boolean arcmode, double s12_a12,
            int caps) {
     ...
     *         90&deg;]. The values of <i>azi1</i> and <i>azi2</i> returned are in
     *         the range [&minus;180&deg;, 180&deg;].
     *         <p>
     *         If either point is at a pole, the azimuth is defined by keeping the
     *         longitude fixed, writing <i>lat</i> = &plusmn;(90&deg; &minus;
     *         &epsilon;), taking the limit &epsilon; &rarr; 0+.
     *         <p>
    ...
    private InverseData InverseInt(double lat1, double lon1, double lat2, double lon2, int outmask) {
        ...
        int lonsign = (int) StrictMath.copySign(1.0, lon12);
        lon12 *= lonsign;
        lon12s *= lonsign;
        double lam12 = CustomStrictMath.toRadians(lon12), slam12, clam12;
        ...
        int swapp = StrictMath.abs(lat1) < StrictMath.abs(lat2) || lat2 != lat2 ? -1 : 1;
        if (swapp < 0) {
            lonsign *= -1;
            {
                double t = lat1;
        ...
        // Make lat1 <= 0
        int latsign = (int) StrictMath.copySign(1.0, -lat1);
        lat1 *= latsign;
        lat2 *= latsign;
        // Now we have
        //
        ...
        sbet1 = p.first;
        cbet1 = p.second;
        cbet1 = StrictMath.max(tiny_, cbet1);
        ...
        sbet2 = p.first;
        cbet2 = p.second;
        cbet2 = StrictMath.max(tiny_, cbet2);
        ...
        if (cbet1 < -sbet1) {
            if (cbet2 == cbet1)
                sbet2 = StrictMath.copySign(sbet1, sbet2);
        } else {
            if (StrictMath.abs(sbet2) == -sbet1)
                cbet2 = cbet1;
        }

        double dn1 = StrictMath.sqrt(1 + _ep2 * GeoMath.sq(sbet1)), dn2 = StrictMath.sqrt(1 + _ep2 * GeoMath.sq(sbet2));
        ...
        if (meridian) {
            ...
            ssig1 = sbet1, csig1 = calp1 * cbet1, ssig2 = sbet2, csig2 = calp2 * cbet2;

            // sig12 = sig2 - sig1 (N.B. with Java max(+0.0, -0.0) -> +0.0)
            sig12 = StrictMath.atan2(StrictMath.max(0.0, csig1 * ssig2 - ssig1 * csig2), csig1 * csig2 + ssig1 * ssig2);
            Lengths(v, _n, sig12, ssig1, csig1, dn1, ssig2, csig2, dn2, cbet1, cbet2,
                    outmask | GeodesicMask.DISTANCE | GeodesicMask.REDUCEDLENGTH, C1a, C2a);
            s12x = v.s12b;
            m12x = v.m12b;
            ...
            if (sig12 < 1 || m12x >= 0) {
                ...
                m12x *= _b;
                s12x *= _b;
                a12 = CustomStrictMath.toDegrees(sig12);
            } else
        ...
        // Mimic the way Lambda12 works with calp1 = 0
            ...
            m12x = _b * StrictMath.sin(sig12);
            if ((outmask & GeodesicMask.GEODESICSCALE) != 0)
                r.M12 = r.M21 = StrictMath.cos(sig12);
            a12 = lon12 / _f1;
            ...
            double dnm;
            {
                InverseStartV s = InverseStart(sbet1, cbet1, dn1, sbet2, cbet2, dn2, lam12, slam12, clam12, C1a, C2a, p,
                        v);
                sig12 = s.sig12;
                salp1 = s.salp1;
                calp1 = s.calp1;
            ...
            if (sig12 >= 0) {
                ...
                s12x = sig12 * _b * dnm;
                m12x = GeoMath.sq(dnm) * _b * StrictMath.sin(sig12 / dnm);
                if ((outmask & GeodesicMask.GEODESICSCALE) != 0)
                    r.M12 = r.M21 = StrictMath.cos(sig12 / dnm);
                a12 = CustomStrictMath.toDegrees(sig12);
                omg12 = lam12 / (_f1 * dnm);
            } else {
                ...
                for (boolean tripn = false, tripb = false;; ++numit) {
                    ...
                    double V, dV;
                    Lambda12(w, sbet1, cbet1, dn1, sbet2, cbet2, dn2, salp1, calp1, slam12, clam12, numit < maxit1_,
                            C1a, C2a, C3a, p, v);
                    V = w.lam12;
                    salp2 = w.salp2;
                    calp2 = w.calp2;
                    ...
                    // Reversed test to allow escape with NaNs
                            !(StrictMath.abs(V) >= (tripn ? 8 : 1) * tol0_) ||
                    ...
                    if (numit < maxit1_ && dV > 0) {
                        double dalp1 = -V / dV;
                        if (StrictMath.abs(dalp1) < StrictMath.PI) {
                            double sdalp1 = StrictMath.sin(dalp1), cdalp1 = StrictMath.cos(dalp1),
                            ...
                            if (nsalp1 > 0) {
                                ...
                                tripn = StrictMath.abs(V) <= 16 * tol0_;
                                continue;
                            }
                        }
                    }
                    ...
                    calp1 = p.second;
                    tripn = false;
                    tripb = (StrictMath.abs(salp1a - salp1) + (calp1a - calp1) < tolb_
                            || StrictMath.abs(salp1 - salp1b) + (calp1 - calp1b) < tolb_);
                }
                {
                    ...
                    int lengthmask = outmask
                            | ((outmask & (GeodesicMask.REDUCEDLENGTH | GeodesicMask.GEODESICSCALE)) != 0
                                    ? GeodesicMask.DISTANCE
                                    : GeodesicMask.NONE);
                    Lengths(v, eps, sig12, ssig1, csig1, dn1, ssig2, csig2, dn2, cbet1, cbet2, lengthmask, C1a, C2a);
                    s12x = v.s12b;
                    m12x = v.m12b;
                    if ((outmask & GeodesicMask.GEODESICSCALE) != 0) {
                        r.M12 = v.M12;
                ...
                if ((outmask & GeodesicMask.AREA) != 0) {
                    // omg12 = lam12 - domg12
                    double sdomg12 = StrictMath.sin(domg12), cdomg12 = StrictMath.cos(domg12);
        ...
        if ((outmask & GeodesicMask.AREA) != 0) {
            ...
            salp0 = salp1 * cbet1, calp0 = StrictMath.hypot(calp1, salp1 * sbet1); // calp0 > 0
            double alp12;
            if (calp0 != 0 && salp0 != 0) {
                double
                // From Lambda12: tan(bet) = tan(sig) * cos(alp)
                ssig1 = sbet1, csig1 = calp1 * cbet1, ssig2 = sbet2, csig2 = calp2 * cbet2,
                        k2 = GeoMath.sq(calp0) * _ep2, eps = k2 / (2 * (1 + StrictMath.sqrt(1 + k2)) + k2),
            ...
            if (!meridian && somg12 == 2) {
                somg12 = StrictMath.sin(omg12);
                comg12 = StrictMath.cos(omg12);
            }
            ...
            if (!meridian && comg12 > -0.7071 && // Long difference not too big
                ...
                alp12 = 2 * StrictMath.atan2(somg12 * (sbet1 * dbet2 + sbet2 * dbet1),
                        domg12 * (sbet1 * sbet2 + dbet1 * dbet2));
            } else {
                // alp12 = alp2 - alp1, used in atan2 so no need to normalize
                double salp12 = salp2 * calp1 - calp2 * salp1, calp12 = calp2 * calp1 + salp2 * salp1;
                ...
                alp12 = StrictMath.atan2(salp12, calp12);
            }
            r.S12 += _c2 * alp12;
     ...
     *         <li><i>outmask</i> |= {@link GeodesicMask#LONG_UNROLL}, if set then
     *         <i>lon1</i> is unchanged and <i>lon2</i> &minus; <i>lon1</i>
     *         indicates whether the geodesic is east going or west going. Otherwise
     *         <i>lon1</i> and <i>lon2</i> are both reduced to the range
     *         [&minus;180&deg;, 180&deg;].
     *         </ul>
     *         <p>
     *         <i>lat1</i>, <i>lon1</i>, <i>lat2</i>, <i>lon2</i>, and <i>a12</i>
     *         are always included in the returned result.
     **********************************************************************/
    ...
    /**
     * Define a {@link GeodesicLine} in terms of the inverse geodesic problem with
     ...
     *         <p>
     *         This function sets point 3 of the GeodesicLine to correspond to point
     *         2 of the inverse geodesic problem.
     *         <p>
     *         <i>lat1</i> and <i>lat2</i> should be in the range [&minus;90&deg;,
     *         90&deg;].
     **********************************************************************/
    ...
    /**
     * Define a {@link GeodesicLine} in terms of the inverse geodesic problem with a
    ...
    public GeodesicLine InverseLine(double lat1, double lon1, double lat2, double lon2, int caps) {
        ...
        double salp1 = result.salp1, calp1 = result.calp1, azi1 = GeoMath.atan2d(salp1, calp1), a12 = result.g.a12;
    ...
    /**
     * Set up to compute several points on a single geodesic with all capabilities
     * included.
     * <p>
     * 
     * @param lat1
     ...
     *         <i>lon1</i> fixed, writing <i>lat1</i> = &plusmn;(90 &minus;
     *         &epsilon;), taking the limit &epsilon; &rarr; 0+.
     **********************************************************************/
     ...
     * @param caps
     *            bitor'ed combination of {@link GeodesicMask} values specifying the
     *            capabilities the {@link GeodesicLine} object should possess, i.e.,
     *            which quantities can be returned in calls to
     *            {@link GeodesicLine#Position GeodesicLine.Position}.
     * @return a {@link GeodesicLine} object.
     *         <p>
     *         The {@link GeodesicMask} values are
     *         <ul>
     *         <li><i>caps</i> |= {@link GeodesicMask#LATITUDE} for the latitude
     *         <i>lat2</i>; this is added automatically;
     *         <li><i>caps</i> |= {@link GeodesicMask#LONGITUDE} for the latitude
     *         <i>lon2</i>;
     *         <li><i>caps</i> |= {@link GeodesicMask#AZIMUTH} for the azimuth
     *         <i>azi2</i>; this is added automatically;
     *         <li><i>caps</i> |= {@link GeodesicMask#DISTANCE} for the distance
     *         <i>s12</i>;
     *         <li><i>caps</i> |= {@link GeodesicMask#REDUCEDLENGTH} for the reduced
     *         length <i>m12</i>;
     *         <li><i>caps</i> |= {@link GeodesicMask#GEODESICSCALE} for the
     *         geodesic scales <i>M12</i> and <i>M21</i>;
     *         <li><i>caps</i> |= {@link GeodesicMask#AREA} for the area <i>S12</i>;
     *         <li><i>caps</i> |= {@link GeodesicMask#DISTANCE_IN} permits the
     *         length of the geodesic to be given in terms of <i>s12</i>; without
     *         this capability the length can only be specified in terms of arc
     *         length;
     *         <li><i>caps</i> |= {@link GeodesicMask#ALL} for all of the above.
     *         </ul>
     *         <p>
    ...
    /**
     * @return <i>a</i> the equatorial radius of the ellipsoid (meters). This is the
    ...
    /**
     * @return <i>f</i> the flattening of the ellipsoid. This is the value used in
     *         the constructor.
     **********************************************************************/
    ...
    /**
     * @return total area of ellipsoid in meters<sup>2</sup>. The area of a polygon
     *         encircling a pole can be found by adding EllipsoidArea()/2 to the sum
     *         of <i>S12</i> for each side of the polygon.
     **********************************************************************/
    public double EllipsoidArea() {
        return 4 * StrictMath.PI * _c2;
    }
    ...
    private void Lengths(LengthsV v, double eps, double sig12, double ssig1, double csig1, double dn1, double ssig2,
            double csig2, double dn2, double cbet1, double cbet2, int outmask,
    ...
    private static double Astroid(double x, double y) {
        ...
        if (!(q == 0 && r <= 0)) {
            ...
            if (disc >= 0) {
                ...
                T3 += T3 < 0 ? -Math.sqrt(disc) : StrictMath.sqrt(disc); // T3 = (r * t)^3
                // N.B. cbrt always returns the double root. cbrt(-8) = -2.
                double T = StrictMath.cbrt(T3); // T = r * t
                // T can be zero; but then r2 / T -> 0.
                u += T + (T != 0 ? r2 / T : 0);
            } else {
                // T is complex, but the way u is defined the result is double.
                double ang = StrictMath.atan2(StrictMath.sqrt(-disc), -(S + r3));
                // There are three possible cube roots. We choose the root which
                // avoids cancellation. Note that disc < 0 implies that r < 0.
                u += 2 * r * StrictMath.cos(ang / 3);
            }
            double v = StrictMath.sqrt(GeoMath.sq(u) + q), // guaranteed positive
                    // Avoid loss of accuracy when u < 0.
                    uv = u < 0 ? q / (v - u) : u + v, // u+v, guaranteed positive
                    w = (uv - q) / (2 * v); // positive?
            // Rearrange expression for k to avoid loss of accuracy due to
            // subtraction. Division by 0 not possible because uv > 0, w >= 0.
            k = uv / (StrictMath.sqrt(uv + GeoMath.sq(w)) + w); // guaranteed positive
        } else { // q == 0 && r <= 0
    ...
    private InverseStartV InverseStart(double sbet1, double cbet1, double dn1, double sbet2, double cbet2, double dn2,
            double lam12, double slam12, double clam12,
            // Scratch areas of the right size
            double C1a[], double C2a[], Pair p, LengthsV v) {
        ...
        sbet12 = sbet2 * cbet1 - cbet2 * sbet1, cbet12 = cbet2 * cbet1 + sbet2 * sbet1;
        double sbet12a = sbet2 * cbet1 + cbet2 * sbet1;
        boolean shortline = cbet12 >= 0 && sbet12 < 0.5 && cbet2 * lam12 < 0.5;
        ...
        if (shortline) {
            ...
            w.dnm = StrictMath.sqrt(1 + _ep2 * sbetm2);
        ...
        w.calp1 = comg12 >= 0 ? sbet12 + cbet2 * sbet1 * GeoMath.sq(somg12) / (1 + comg12)
                : sbet12a - cbet2 * sbet1 * GeoMath.sq(somg12) / (1 - comg12);

        double ssig12 = StrictMath.hypot(w.salp1, w.calp1), csig12 = sbet1 * sbet2 + cbet1 * cbet2 * comg12;
        ...
        if (shortline && ssig12 < _etol2) {
            ...
            w.calp2 = p.second;
            // Set return value
            w.sig12 = StrictMath.atan2(ssig12, csig12);
        } else if (StrictMath.abs(_n) > 0.1 || // Skip astroid calc if too eccentric
                csig12 >= 0 || ssig12 >= 6 * StrictMath.abs(_n) * StrictMath.PI * GeoMath.sq(cbet1)) {
            // Nothing to do, zeroth order spherical approximation is OK
        } else {
            // Scale lam12 and bet2 to x, y coordinate system where antipodal point
            // is at origin and singular point is at y = 0, x = -1.
            double x, y, lamscale, betscale;
            double lam12x = StrictMath.atan2(-slam12, -clam12); // lam12 - pi
            if (_f >= 0) { // In fact f == 0 does not get here
                // x = dlong, y = dlat
                {
                    double k2 = GeoMath.sq(sbet1) * _ep2, eps = k2 / (2 * (1 + StrictMath.sqrt(1 + k2)) + k2);
                    lamscale = _f * cbet1 * A3f(eps) * StrictMath.PI;
                }
                ...
                // x = dlat, y = dlong
                double cbet12a = cbet2 * cbet1 - sbet2 * sbet1, bet12a = StrictMath.atan2(sbet12a, cbet12a);
                double m12b, m0;
                // In the case of lon12 = 180, this repeats a calculation made in
                // Inverse.
                Lengths(v, _n, StrictMath.PI + bet12a, sbet1, -cbet1, dn1, sbet2, cbet2, dn2, cbet1, cbet2,
                        GeodesicMask.REDUCEDLENGTH, C1a, C2a);
                m12b = v.m12b;
                m0 = v.m0;

                x = -1 + m12b / (cbet1 * cbet2 * m0 * StrictMath.PI);
                betscale = x < -0.01 ? sbet12a / x : -_f * GeoMath.sq(cbet1) * StrictMath.PI;
            ...
            if (y > -tol1_ && x > -1 - xthresh_) {
                // strip near cut
                if (_f >= 0) {
                    w.salp1 = StrictMath.min(1.0, -x);
                    w.calp1 = -StrictMath.sqrt(1 - GeoMath.sq(w.salp1));
                } else {
                    w.calp1 = StrictMath.max(x > -tol1_ ? 0.0 : -1.0, x);
                    w.salp1 = StrictMath.sqrt(1 - GeoMath.sq(w.calp1));
                }
            } else {
    ...
    private class Lambda12V {
        private double lam12, salp2, calp2, sig12, ssig1, csig1, ssig2, csig2, eps, domg12, dlam12;
    ...
    private void Lambda12(Lambda12V w, double sbet1, double cbet1, double dn1, double sbet2, double cbet2, double dn2,
            double salp1, double calp1, double slam120, double clam120, boolean diffp,
            // Scratch areas of the right size
            double C1a[], double C2a[], double C3a[], Pair p, LengthsV v) {
        ...
        w.sig12 = StrictMath.atan2(StrictMath.max(0.0, w.csig1 * w.ssig2 - w.ssig1 * w.csig2),
                w.csig1 * w.csig2 + w.ssig1 * w.ssig2);

        // omg12 = omg2 - omg1, limit to [0, pi]
        somg12 = StrictMath.max(0.0, comg1 * somg2 - somg1 * comg2);
        comg12 = comg1 * comg2 + somg1 * somg2;
        // eta = omg12 - lam120
        double eta = StrictMath.atan2(somg12 * clam120 - comg12 * slam120, comg12 * clam120 + somg12 * slam120);
        double B312;
        double k2 = GeoMath.sq(calp0) * _ep2;
        w.eps = k2 / (2 * (1 + StrictMath.sqrt(1 + k2)) + k2);
        C3f(w.eps, C3a);
        ...
        if (diffp) {
            if (w.calp2 == 0)
                ...
                Lengths(v, w.eps, w.sig12, w.ssig1, w.csig1, dn1, w.ssig2, w.csig2, dn2, cbet1, cbet2,
                        GeodesicMask.REDUCEDLENGTH, C1a, C2a);
                w.dlam12 = v.m12b;
    ...
    protected void A3coeff() {
        ...
        for (int j = nA3_ - 1; j >= 0; --j) { // coeff of eps^j
            int m = StrictMath.min(nA3_ - j - 1, j); // order of polynomial in n
    ...
    protected void C3coeff() {
        ...
        for (int l = 1; l < nC3_; ++l) { // l is index of C3[l]
            for (int j = nC3_ - 1; j >= l; --j) { // coeff of eps^j
                int m = StrictMath.min(nC3_ - j - 1, j); // order of polynomial in n
