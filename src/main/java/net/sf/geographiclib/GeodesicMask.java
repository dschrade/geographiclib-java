 ...
 * Geodesic.Direct} and
 * {@link Geodesic#Inverse(double, double, double, double, int)
 * Geodesic.Inverse} routines. They also signify (via the <i>caps</i> parameter)
 * to the
 * {@link GeodesicLine#GeodesicLine(Geodesic, double, double, double, int)
 * GeodesicLine.GeodesicLine} constructor and to
 * {@link Geodesic#Line(double, double, double, int) Geodesic.Line} what
 * capabilities should be included in the {@link GeodesicLine} object.
 **********************************************************************/
public class GeodesicMask {
     ...
     * include this as a capability to {@link GeodesicLine} because this is included
     * by default.)
     **********************************************************************/
    ...
    /**
     * Allow distance <i>s12</i> to be used as <i>input</i> in the direct geodesic
     * problem.
     **********************************************************************/
    ...
    /**
     * All capabilities, calculate everything. (LONG_UNROLL is not included in this
     * mask.)
     **********************************************************************/
