 ...
 * {@link Geodesic#Direct(double, double, double, double) Geodesic.Direct} and
 * {@link Geodesic#Inverse(double, double, double, double) Geodesic.Inverse} and
 * it always includes the field <i>a12</i>.
 **********************************************************************/
